...
import { StyleSheet, View, Text, Image, Dimensions, TouchableOpacity, ActivityIndicator,TextInput, NativeModules, } from 'react-native';
    ...
    <View style={{flex:1}}>
     ...
     {/* <View style={styles.placeContainer}>
      ...
      <TouchableOpacity style={styles.button2} onPress={() => getBLEPermission()}>
        <Text style={styles.buttonText}>Sai Home 블루투스 연결하기</Text>
      </TouchableOpacity>
    </View>
  ) : (
    <View style={styles.indicator}>
...
const styles = StyleSheet.create({
  ...
  picoHomeBig: { marginTop: height * 0.2, alignItems: 'center' },
  button2: {
    alignSelf:'flex-end',
    position: 'absolute',
    //top: height * 0.74,
