    ...
    <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
      <View style={styles.container}>
        <View style={styles.picoHomeImage}>
          <Image source={require('../../Assets/img/app_logo.jpg')} style={{height:130,width:130,marginTop:height*0.06} } />
        </View>
        <View style={styles.signInViewStyle}>
          ...
          {/* <TouchableOpacity style={styles.buttonStyle2} onPress={() => signIn(id, pw, '', '', '', '')}>
